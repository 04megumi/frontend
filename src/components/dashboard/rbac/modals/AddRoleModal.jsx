      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
        ...
        <form className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            <button type="button" onClick={handleAddRole} className="px-4 py-2 border border-transparent rounded-md text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
              Add Role
            </button>
          </div>
        </form>
